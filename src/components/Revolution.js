...
export default function Revolution() {
            ...
            className={classes.rowContainer} 
             >
                <Grid item lg>
                    ...
                    style={{maxWidth: matchesMD ? 300 : "40em", 
                ...
                style={{maxWidth: "40em"}}>
                    <Grid item>
                        <Typography align={matchesMD? "center": "right"}
            ...
            style={{marginTop: "10em", marginBottom: "10em"}}
             >
                ...
                style={{maxWidth: "40em"}}>
                    <Grid item>
                        <Typography 
                         variant="h4" align={matchesMD? "center": "left"} gutterBottom>
                            Technology
                        </Typography>
                    </Grid>
                    <Grid item>
                        <Typography align={matchesMD? "center": "left"}  variant="body1"
                        paragraph>
            ...
            style={{backgroundColor: "#B3B3B3"}}>
                <Grid item container direction="column" lg>
                    ...
                    <Grid item>
                        ...
                        <Typography align={matchesMD? "center": "left"} variant="body1" 
                        style={{color: "#fff", maxWidth: "20em", marginBottom: "2em"}}
                        paragraph>
    ...
    <Grid item container direction={matchesMD? "column" : "row"} 
            ...
            style={{backgroundColor: "#FF7373"}}>
                <Grid item container direction="column" lg>
                    <Grid item>
                        <Typography align={matchesMD? "center": "left"} variant="h4" 
                        style={{color: "#000", marginTop: "2em"}}
                        gutterBottom >
                            Mockup
                        </Typography>
    ...
    <Grid item container direction={matchesMD? "column" : "row"} 
            ...
            style={{backgroundColor: "#39B54A"}}>
                ...
                style={{alignSelf: "center"}}>
                    ...
                    width="100%"
                    style={{maxWidth: matchesMD ? 300 : 400}} />
                </Grid>
            </Grid>
    {/* Review Section Ends */}
    ...
    <Grid item container direction={matchesMD? "column" : "row"} 
            ...
            style={{backgroundColor: "#A67C52"}}>
                ...
                style={{alignSelf: "center"}}>
                    ...
                    width="100%"
                    style={{maxWidth: matchesMD ? 700 : 1200}} />
                </Grid>
            </Grid>
    {/* Mockup Section Ends */}
{/* Design section end */}

    {/* Review 2 Section Starts */}
    <Grid item container direction={matchesMD? "column" : "row"} 
            className={classes.rowContainer}
            style={{backgroundColor: "#39B54A"}}>
                <Grid item container direction="column" lg>
...
Each area is then developed in order of importance until ready to be connected to the next piece.
                ...
                style={{alignSelf: "center"}}>
                    ...
                    width="100%"
                    style={{maxWidth: matchesMD ? 500 : 700}} />
                </Grid>
            </Grid>
    {/* Build Section Ends */}


    {/* Launch Section Starts */}
    <Grid item container direction={matchesMD? "column" : "row"}
            className={classes.rowContainer}
            style={{backgroundColor: "#C1272D"}}>
                ...
                marginBottom:"2em"}}>
                    ...
                    width="100%"
                    style={{maxWidth: matchesMD ? 50 : 100}} />
                </Grid>
            </Grid>
    {/* Launch Section Ends */}

    {/* Maintain Section Starts */}
    <Grid item container direction={matchesMD? "column" : "row"} 
            className={classes.rowContainer}
            style={{backgroundColor: "#8E45CE"}}>
                ...
                style={{alignSelf: "center"}}>
                    ...
                    width="100%"
                    style={{maxWidth: matchesMD ? 200 : 300}} />
                </Grid>
            </Grid>
    {/* Maintain Section Ends */}
